...
const btnViewAll = document.getElementById('btn_select-all');
const btnViewActive = document.getElementById('btn_select-active');
const btnViewCompleted = document.getElementById('btn_select-completed');
let foo = '';
let todos = [];
